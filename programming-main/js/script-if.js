...

{
    ...
    if(x1 == x3){
        alert("Это число палиндром " + num);
    }
    else {
        alert("Это число не палиндром " + num);
    }
}

{
    ...
    if(a == b && b == c ) {
        ...
        alert("Нет совпадение между всеми числами ");
    }
}

{
    ...
    alert("Произведение всех целых чисел от 8 до 15 = " + num1);
    ...
    let num2,a2;
    a2 = parseInt(prompt("Введите число от 1 до 20"));
    num2 = 1;
    for(i = a2; i<=20; i++){
        num *= i;
    }
    alert("произведение всех целых чисел от a до 20 = " + num2);
    ...
    alert("произведение всех целых чисел от 1 до b = " + num3);
    ...
    alert("произведение всех целых чисел a и b = " + num);
...

{
    ...
    let sum, numbers, num,znach,i;
    sum = 0;
    numbers = 10;
    for (i = 1; i <= numbers; i++) {
    num = parseInt(prompt("Введите число a" + i));
    sum += num;
    }
    znach = sum / numbers;
    alert("Среднее арифметическое: " + znach);
}

{
    ...
    if (firstDigit <= 6) {
        alert("Первая цифра не превышает 6");
    } else if (firstDigit > 6) {
        alert("Первая цифра превышает 6");
    }

    if (firstDigit === lastDigit) {
        alert("Число начинается и заканчивается одной и той же цифрой");
    } else {
        alert("Число не начинается и не заканчивается одной и той же цифрой");
    }
